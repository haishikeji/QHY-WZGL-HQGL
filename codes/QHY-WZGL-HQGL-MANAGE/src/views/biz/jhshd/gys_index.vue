...
<script setup name="jhshd">
	...
	import mxIndex from './gys_mx_index.vue'
	...
	const loadData = (parameter) => {
		...
		return gysApi.cgJhShdPage(Object.assign(parameter, searchFormParam)).then((data) => {
			return data
		})
	}
	// 重置
	...
	const print = (record) => {
		visible.value = true
		src.value = 'https://hqncg.just.edu.cn/decision/view/report?viewlet=cgjkd%252Fdjdy%252Fcgshd.cpt&id=' + record.id
	}
</script>
