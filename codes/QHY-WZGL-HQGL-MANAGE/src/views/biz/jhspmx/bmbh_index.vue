...
<!--                    />-->
    ...
    <Form ref="formRef" @successful="table.refresh(true);table.clearRefreshSelected();" />
	<menu-selector-plus
...
<script setup name="bmbh">
    ...
    let searchFormState = reactive({cglx:'部门备货',workstate:'申请中'})
	...
	const selectSp = (record) => {
		...
		const param = {
			id: 1,
			bmdm: record.bmdm?record.bmdm:searchFormState.bmdm,
			sqdh: record.sqdh
		}
