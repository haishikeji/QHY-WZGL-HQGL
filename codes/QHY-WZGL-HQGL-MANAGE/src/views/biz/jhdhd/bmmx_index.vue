			...
			<a-row :gutter="24">
				<a-col :xxl="6" :xl="6" :lg="8" :md="12" :sm="24">
					<a-form-item label="供应商名称" name="gysmc">
						<a-input v-model:value="searchFormState.gysmc" placeholder="请输入申请人" readonly="readonly"/>
					</a-form-item>
				</a-col>
				<a-col :xxl="6" :xl="6" :lg="8" :md="12" :sm="24">
					<a-form-item label="需货日期：" name="cgrq">
						<a-date-picker readonly="readonly" v-model:value="searchFormState.cgrq" value-format="YYYY-MM-DD HH:mm:ss" show-time placeholder="请选择需货日期" style="width: 100%" />
					</a-form-item>
				</a-col>
			</a-row>
		</a-form>
...
<script setup name="jhsqd">
	...
	const onOpen = (record)=>{
		...
		searchFormState.cgrq = record.cgrq;
	}
	// 关闭抽屉
	const onClose = () => {
		formData.value = {}
