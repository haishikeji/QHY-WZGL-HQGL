...
<script setup name="jhdhd">
	...
	import bzmxIndex from './bzmx_index.vue'
	import cgCodeGysApi from '@/api/biz/cgCodeGysApi'
	import dayjs from 'dayjs'
	let searchFormState = reactive({ dhrq: [dayjs().format('YYYY-MM-DD'), dayjs().format('YYYY-MM-DD')] })
	...
	const loadData = (parameter) => {
		...
		return cgJhDhdApi.cgJhDhdPage(Object.assign(parameter, searchFormParam)).then((data) => {
			return data
		})
	}
	// 重置
