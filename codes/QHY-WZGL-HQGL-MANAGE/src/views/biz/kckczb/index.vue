<template>
		...
		>
			<template #bodyCell="{ column, record }">
				<template v-if="column.dataIndex === 'action'">
					<a-space>
						<a @click="bmindexRef.onOpen(record)">部门库存</a>
	...
	<bmIndex ref="bmindexRef" @successful="table.refresh(true)" />
...
<script setup name="kckczb">
	...
	import bmIndex from './bm_index.vue'
	...
	const loadData = (parameter) => {
		...
		return cgKcKczbApi.cgKcKczbHzPage(Object.assign(parameter, searchFormParam)).then((data) => {
			return data
		})
	}
	// 重置
